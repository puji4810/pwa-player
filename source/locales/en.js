...
const EN_TRANSLATIONS = {
    ...
    subtitles: "Subtitles",
    subtitleAutoLoadMode: "Auto-load subtitles",
    subtitleOff: "Off",
    ...
    buttonSizeHint: "Adjust the size of control buttons. Compact removes gaps between buttons.",
    compact: "Compact",
    normal: "Normal",
    large: "Large",
    ...
    enterRemoteName: "Enter a name for this remote server (no special characters like . / \\ : * ? \" < > |):",
    nameRequired: "Name is required. Please try again.",
    cancelledAfterAttempts: "Operation cancelled after failed attempts.",
    remote: "Remote",
