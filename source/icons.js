...
(function () {
    ...
    const ICONS = {
        ...
        sliders: S('<path d="M4 7h6M14.5 7H20"/><circle cx="12.2" cy="7" r="1.9"/><path d="M4 12h2M10.5 12H20"/><circle cx="8.2" cy="12" r="1.9"/><path d="M4 17h10M18.5 17H20"/><circle cx="16.2" cy="17" r="1.9"/>'),
        home: S('<path d="M4.2 11.4L12 4.5l7.8 6.9"/><path d="M6.2 10v9.5h4.3v-5h3v5h4.3V10"/>'),
